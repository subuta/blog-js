...
export default () => {
  return (
    <section>
      ...
      <p>Your privacy is important to us. It is sub-labo's policy to respect your privacy regarding any information we
        may collect from you across our website, <a href="https://sub-labo.com">https://sub-labo.com</a>, and other
      ...
      <p>Your continued use of our website will be regarded as acceptance of our practices around privacy and personal
        ...
        contact us.</p>
      <p>This policy is effective as of 1 January 2018.</p>
    </section>
  )
}
